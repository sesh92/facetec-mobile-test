...
public class AuthenticateProcessor extends Processor implements FaceTecFaceScanProcessor {
    ...
    public AuthenticateProcessor(String sessionToken, FacetecUtilities utils, Activity activity) {
        ...
        //
        FaceTecSessionActivity.createAndLaunchSession(activity, AuthenticateProcessor.this, sessionToken);
    }
    ...
    public void processSessionWhileFaceTecSDKWaits(final FaceTecSessionResult sessionResult, final FaceTecFaceScanResultCallback faceScanResultCallback) {
        ...
        if(sessionResult.getStatus() != FaceTecSessionStatus.SESSION_COMPLETED_SUCCESSFULLY) {
            ...
            promise.reject(new Error("status is not SESSION_COMPLETED_SUCCESSFULLY" + sessionResult.getStatus()));
            return;
        }
        ...
        NetworkingHelpers.getApiClient().newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull okhttp3.Response response) throws IOException {
                ...
                try {
                    ...
                    Log.d("scanResultBlob", scanResultBlob);
